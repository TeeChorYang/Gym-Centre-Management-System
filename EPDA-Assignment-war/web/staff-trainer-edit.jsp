<%-- 
    Document   : staff-trainer-edit
    Created on : May 11, 2024, 10:03:37 PM
    Author     : TheOne
--%>
      ...
      <div class="min-h-full">
              ...
              <div class="flex items-center">
                ...
                <div class="hidden md:block">
                  <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="StaffTrainerInformation" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Trainers</a>
        ...
        <header class="bg-white shadow">
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Edit Trainer</h1>
          </div>
        </header>
        <main>
          <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <form action="StaffTrainerEdit" method="POST">
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                      <h2 class="text-base font-semibold leading-7 text-gray-900">Trainer Information</h2>
                      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-full">
                          <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Username</label>
                          <div class="mt-2">
                            <input type="hidden" name="id" value="<%= ((AgcTrainer)request.getAttribute("trainer")).getId() %>" />
                            <input type="text" name="id" id="username" value="<%= ((AgcTrainer)request.getAttribute("trainer")).getId() %>" disabled class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 bg-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                         ...
                         <div class="sm:col-span-full">
                          ...
                          <div class="mt-2">
                            <input type="text" name="name" id="name" value="<%= ((AgcTrainer)request.getAttribute("trainer")).getName() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                          ...
                          <div class="mt-2">
                            <input id="email" name="email" type="email" value="<%= ((AgcTrainer)request.getAttribute("trainer")).getEmail() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                         ...
                         <div class="sm:col-span-3">
                          ...
                          <div class="mt-2">
                            <input type="text" name="phone" id="phone" value="<%= ((AgcTrainer)request.getAttribute("trainer")).getPhone() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                          
                        <div class="sm:col-span-3">
                            <fieldset>
                              <legend class="text-sm font-semibold leading-6 text-gray-900">Approve?</legend>
                              <p class="mt-1 text-sm leading-6 text-gray-600">Accounts must be approved for user to access.</p>
                              <div class="mt-6 space-y-6">
                                <div class="flex items-center gap-x-3">
                                    <input id="yes" name="is_approve" value="true" type="radio" 
                                        <%= ((AgcTrainer)request.getAttribute("trainer")).getIs_approve() ? "checked" : "" %>
                                        class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    <label for="yes" class="block text-sm font-medium leading-6 text-gray-900">Yes</label>
                                  </div>
                                  <div class="flex items-center gap-x-3">
                                    <input id="no" name="is_approve" value="false" type="radio" 
                                        <%= ((AgcTrainer)request.getAttribute("trainer")).getIs_approve() ? "" : "checked" %> 
                                       class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">

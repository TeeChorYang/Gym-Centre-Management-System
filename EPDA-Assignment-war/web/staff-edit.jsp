<%-- 
    Document   : staff-edit
    Created on : May 11, 2024, 3:53:56 PM
    Author     : TheOne
--%>
      ...
      <div class="min-h-full">
        ...
        <header class="bg-white shadow">
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Edit Staff</h1>
          </div>
        </header>
        <main>
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                      ...
                      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-full">
                          ...
                          <div class="mt-2">
                            <input type="hidden" name="id" value="<%= ((AgcStaff)request.getAttribute("staff")).getId() %>" />
                            <input type="text" name="username" id="username" value="<%= ((AgcStaff)request.getAttribute("staff")).getId() %>"  class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 bg-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                         ...
                         <div class="sm:col-span-full">
                          ...
                          <div class="mt-2">
                            <input type="text" name="name" id="name" value="<%= ((AgcStaff)request.getAttribute("staff")).getName() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                          ...
                          <div class="mt-2">
                            <input id="email" name="email" type="email" value="<%= ((AgcStaff)request.getAttribute("staff")).getEmail() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                         ...
                         <div class="sm:col-span-3">
                          ...
                          <div class="mt-2">
                            <input type="text" name="phone" id="phone" value="<%= ((AgcStaff)request.getAttribute("staff")).getPhone() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                            ...
                            <fieldset>
                              ...
                              <div class="mt-6 space-y-6">
                                <div class="flex items-center gap-x-3">
                                    <input id="yes" name="is_admin" value="true" type="radio" 
                                           <%= ((AgcStaff)request.getAttribute("staff")).getIs_admin() ? "checked" : "" %> 
                                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    <label for="yes" class="block text-sm font-medium leading-6 text-gray-900">Yes</label>
                                  </div>
                                  <div class="flex items-center gap-x-3">
                                    <input id="no" name="is_admin" value="false" type="radio" 
                                           <%= ((AgcStaff)request.getAttribute("staff")).getIs_admin() ? "" : "checked" %> 
                                           class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">

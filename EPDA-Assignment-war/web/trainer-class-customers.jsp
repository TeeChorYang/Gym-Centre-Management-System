<%-- 
    Document   : trainer-class-customers
    Created on : May 19, 2024, 12:57:56 AM
    Author     : TheOne
--%>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">  
                                <a href="TrainerCustomerFeedback?id=<%= customer.getId() %>&classId=<%= request.getAttribute("classId") %>" class="text-blue-600 hover:text-blue-900">Feedback</a>
                            </td>
                        </tr>
                        <% 
                                }

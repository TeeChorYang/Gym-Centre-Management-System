<%-- 
    Document   : staff-customer-edit
    Created on : May 12, 2024, 6:00:35 PM
    Author     : TheOne
--%>
      ...
      <div class="min-h-full">
              ...
              <div class="flex items-center">
                ...
                <div class="hidden md:block">
                  <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="StaffCustomerInformation" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Customers</a>
        ...
        <header class="bg-white shadow">
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Edit Customer</h1>
          </div>
        </header>
        <main>
          <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <form action="StaffCustomerEdit" method="POST">
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                      ...
                      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-full">
                          ...
                          <div class="mt-2">
                            <input type="hidden" name="id" value="<%= ((AgcCustomer)request.getAttribute("customer")).getId() %>" />
                            <input type="text" name="id" id="username" value="<%= ((AgcCustomer)request.getAttribute("customer")).getId() %>" disabled class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 bg-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                         ...
                         <div class="sm:col-span-full">
                          ...
                          <div class="mt-2">
                            <input type="text" name="name" id="name" value="<%= ((AgcCustomer)request.getAttribute("customer")).getName() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                          ...
                          <div class="mt-2">
                            <input id="email" name="email" type="email" value="<%= ((AgcCustomer)request.getAttribute("customer")).getEmail() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                         ...
                         <div class="sm:col-span-3">
                          ...
                          <div class="mt-2">
                            <input type="text" name="phone" id="phone" value="<%= ((AgcCustomer)request.getAttribute("customer")).getPhone() %>" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                          </div>
                        </div>
                              ...
                              <div class="mt-6 space-y-6">
                                <div class="flex items-center gap-x-3">
                                    <input id="yes" name="is_approve" value="true" type="radio" 
                                        <%= ((AgcCustomer)request.getAttribute("customer")).getIs_approve() ? "checked" : "" %>

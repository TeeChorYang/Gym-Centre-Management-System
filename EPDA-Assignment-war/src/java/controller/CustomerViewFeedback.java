 ...
 * @author TheOne
 */
@WebServlet(name = "CustomerViewFeedback", urlPatterns = {"/CustomerViewFeedback"})
public class CustomerViewFeedback extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("customer-view-feedback.jsp").forward(request, response);
    }

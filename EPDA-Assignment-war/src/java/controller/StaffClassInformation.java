 ...
 * @author TheOne
 */
@WebServlet(name = "StaffClassInformation", urlPatterns = {"/StaffClassInformation"})
public class StaffClassInformation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (searchQuery != null && !searchQuery.isEmpty()) {
            classList = agcClassFacade.findAllClass().stream()
                .filter(agcClass -> agcClass.getName().toLowerCase().contains(searchQuery.toLowerCase())
                    ...
                    || agcClass.getTrainerId().toLowerCase().contains(searchQuery.toLowerCase()))
        ...
        request.getRequestDispatcher("staff-class-information.jsp").include(request, response);
    }

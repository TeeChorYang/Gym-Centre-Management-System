 ...
 * @author TheOne
 */
@WebServlet(name = "TrainerClassEdit", urlPatterns = {"/TrainerClassEdit"})
public class TrainerClassEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String description = request.getParameter("description");
           ...
           try (PrintWriter out = response.getWriter()) {
                ...
                response.sendRedirect("TrainerClassEdit?id=" + id);
            } catch (Exception e) {
                   HttpSession s = request.getSession(false);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
         ...
         request.getRequestDispatcher("trainer-class-edit.jsp").forward(request, response);
     }

 ...
 * @author TheOne
 */
@WebServlet(name = "TrainerClassCustomers", urlPatterns = {"/TrainerClassCustomers"})
public class TrainerClassCustomers extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<AgcCustomer> customers = customerHasClassFacade.findCustomerIdsByClassId(classId);

        request.setAttribute("customers", customers);

        request.getRequestDispatcher("trainer-class-customers.jsp").forward(request, response);
    }

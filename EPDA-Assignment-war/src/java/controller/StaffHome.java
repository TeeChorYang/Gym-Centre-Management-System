...
public class StaffHome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("staffName", c.getName());

        Long totalTrainers = agcTrainerFacade.countTrainers();
        request.setAttribute("totalTrainers", totalTrainers);

        Long totalCustomers = agcCustomerFacade.countCustomers();
        request.setAttribute("totalCustomers", totalCustomers);

        Long totalClasses = agcClassFacade.countClasses();
        request.setAttribute("totalClasses", totalClasses);

        request.getRequestDispatcher("staff-dashboard.jsp").include(request, response);
    }

 ...
 * @author TheOne
 */
@WebServlet(name = "StaffClassCustomers", urlPatterns = {"/StaffClassCustomers"})
public class StaffClassCustomers extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("staff-class-customers.jsp").forward(request, response);
    }

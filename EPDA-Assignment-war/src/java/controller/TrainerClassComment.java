 ...
 * @author TheOne
 */
@WebServlet(name = "TrainerClassComment", urlPatterns = {"/TrainerClassComment"})
public class TrainerClassComment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<AgcComments> comments = agcCommentsFacade.findCommentsByClassId(classId);

        request.setAttribute("comments", comments);

        request.getRequestDispatcher("trainer-class-comment.jsp").forward(request, response);
    }

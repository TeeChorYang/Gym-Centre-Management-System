<%-- 
    Document   : error
    Created on : May 11, 2024, 1:48:23 AM
    Author     : TheOne
--%>
    ...
    <body class="h-full">
      ...
      <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
          ...
          <p class="mt-4 text-2xl font-bold tracking-tight text-indigo-600 sm:text-3xl">Forbidden</p><br>
          <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"><%= request.getAttribute("errorMessage") %></p>
                <p class="mt-6 text-lg leading-8 text-gray-600">
                We regret to inform you that access to this page is restricted. <br>Your current permissions do not allow entry.
                <br>Please review your access privileges or contact the appropriate authority for further assistance. Thank you.
                </p>
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a href="StaffHome" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 

<%-- 
    Document   : staff-customer-information
    Created on : May 12, 2024, 1:28:39 PM
    Author     : TheOne
--%>
      ...
      <div class="min-h-full">
        ...
        <header class="bg-white shadow">
          <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Customer's Information</h1>
          </div>
        </header>
        <main>
                  ...
                  <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody class="divide-y divide-gray-200">
                        <% 
                            List<AgcCustomer> customerList = null;
                            if (request.getAttribute("customerList") != null) {
                                customerList = (List<AgcCustomer>) request.getAttribute("customerList");
                            }
                            if (customerList != null) {
                                for (AgcCustomer customer : customerList) {
                        %>
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><%= customer.getIs_approve() %></td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">  
                                <a href="StaffCustomerEdit?id=<%= customer.getId() %>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="#" onclick="confirmDelete('<%= customer.getId() %>')" class="text-red-600 hover:text-red-900">Delete</a>
                            </td>
                        </tr>
                        <% 
                                }
        ...
        <script>
            function confirmDelete(id) {
                if (confirm('Are you sure you want to delete this customer?')) {
                    window.location.href = 'StaffCustomerDelete?id=' + id;
                }
            };

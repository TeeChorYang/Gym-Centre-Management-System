<%-- 
    Document   : trainer-class
    Created on : May 18, 2024, 2:50:21 PM
    Author     : TheOne
--%>
                    ...
                    <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
                      <div class="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
                        ...
                        <div class="ml-4 mt-2 flex-shrink-0">
                          <a href="trainer-class-create.jsp" class="relative inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium 
                             rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Create new class</a>
                        </div>
                      ...
                      <tbody class="divide-y divide-gray-200">
                        ...
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">  
                                <a href="TrainerClassEdit?id=<%= agcClass.getId() %>" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">  
                                <a href="TrainerClassCustomers?id=<%= agcClass.getId() %>" class="text-green-600 hover:text-green-900">View Customers</a>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">  
                                <a href="TrainerClassComment?id=<%= agcClass.getId() %>" class="text-yellow-600 hover:text-yellow-900">View Comments</a>
                            </td>

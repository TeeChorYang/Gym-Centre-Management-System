<%-- 
    Document   : trainer-class-comment
    Created on : May 19, 2024, 12:18:44 PM
    Author     : TheOne
--%>
...
<%@page import="models.AgcComments"%>
<!DOCTYPE html>
<html>
     <head>
        <meta charset="UTF-8">
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <ul role="list" class="divide-y divide-gray-200">
                    <% List<AgcComments> comments = (List<AgcComments>) request.getAttribute("comments");
                            ...
                            <div class="flex justify-between space-x-3">
                                <div class="min-w-0 flex-1">
                                    <a href="#" class="block focus:outline-none">
                                        ...
                                        <p class="text-sm font-medium text-gray-900 truncate">Customer ID: <%= comment.getCustomerId() %></p>
                                    </a>
                                </div>
                                <time datetime="<%= comment.getCommentDate() %>" class="flex-shrink-0 whitespace-nowrap text-sm text-gray-500"><%= comment.getCommentDate() %></time>
                            </div>
                            <div class="mt-1">
                                <p class="line-clamp-2 text-sm text-gray-600"><%= comment.getComment() %></p>
                            </div>
                        </li>
                    <% } %>
                </ul>

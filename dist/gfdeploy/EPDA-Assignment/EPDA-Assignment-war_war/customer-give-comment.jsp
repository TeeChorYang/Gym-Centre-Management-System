<%-- 
    Document   : customer-give-comment
    Created on : May 21, 2024, 8:41:32 AM
    Author     : TheOne
--%>
    ...
    <body>
        ...
        <main>
          <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <form action="CustomerGiveComment" method="POST">
              <div class="space-y-12">
                  <div class="border-b border-gray-900/10 pb-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Create Comment</h2>
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                      <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="text" name="class_id" id="class_id" value="<%= classId %>" disabled class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 bg-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                      </div>
                      ...
                      <div class="sm:col-span-full">
                          ...
                          <div class="mt-2">
                              <textarea name="comment" id="comment" rows="4" cols="50" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                          </div>
                      </div>
